...
- The Docker socket is mounted from the host and `docker` CLI is installed. You can run Docker commands, including spinning up containers for integration tests.
