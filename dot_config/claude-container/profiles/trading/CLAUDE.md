...
- Git and jj (Jujutsu) are available for version control. Host paths in VCS metadata (e.g. `/Users/...`) resolve correctly inside the container via a symlink — just run jj commands normally, they will work.
