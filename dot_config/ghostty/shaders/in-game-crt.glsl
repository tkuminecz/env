...
// (x, y) \in R^2 : x, y > 0  — lower = MORE curved (10,8 is noticeably rounder; 6,5 is dramatic)
#define CURVE 10.0, 8.0
...
// Lower = flatter/brighter edges. 0.10 keeps outer area ~97% of center;
